...
<head>
    ...
    <style>
        ...
        .circle {
            width: 300px; /* Dimensioni dell'immagine tonda */
            height: 300px;
            border-radius: 50%; /* Per rendere l'immagine tonda */
            overflow: hidden; /* Nasconde parti dell'immagine che superano il bordo del cerchio */
            margin-right: 20px; /* Spazio a destra dell'immagine */
        }
        .circle img {
            width: 100%; /* Riempie completamente il cerchio */
            height: auto;
        }
        .line {
            width: 5px; /* Spessore della linea verticale */
            height: 350px; /* Altezza della linea */
            background-color: #333; /* Colore della linea */
            margin-right: 20px; /* Spazio a destra della linea */
        }
        .caption {
        ...
        .options {
            ...
            padding: 0;
            columns: 2; /* Dividere in due colonne */
        }
